...
<br><br>
<b>强烈推荐：</b>推荐使用本人onlyoffice镜像 <code>funggtopp/docker-onlyoffice-ds</code> 。字体支持完美。<br><br>
<b>特别提醒：</b>推荐使用mini_fonts。它能较好地支持7.X版本。文件夹下有两个黑体文件，1、较老的版本，需要同时使用；只有这样才能使所有字体正常显示。因为windows不区分大小写，因此使用微软系统进行字体处理时需要特别注意。2、新的7.3及以上版本，可以将黑体中tsimhei.TTF删除（注意大小写）。<br><br>
